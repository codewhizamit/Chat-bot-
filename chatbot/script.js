const API_KEY = "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";
...
async function fetchGroqData(messages) {
  try {
    ...
    if (!response.ok) {
      ...
      throw new Error(`HTTP error! status: ${response.status}, body: ${errorBody}`); // Fixed template literal syntax
    }
...
// Clear the chat display initially
chatDisplay.innerHTML = "";

// Add a placeholder message to the chat display
appendMessage("Welcome to the chat! Type your message below.");
